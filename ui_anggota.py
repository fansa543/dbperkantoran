...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayoutWidget.setGeometry(QRect(10, 10, 301, 101))
        self.formLayout = QFormLayout(self.formLayoutWidget)
        self.formLayout.setObjectName(u"formLayout")
        self.formLayout.setContentsMargins(0, 0, 0, 0)

        # ===== Label dan Input ID Pegawai =====
        ...
        self.btnSimpan.setGeometry(QRect(10, 120, 101, 18))

        self.btnHapus = QPushButton(Form)
        self.btnHapus.setObjectName(u"btnHapus")
        self.btnHapus.setGeometry(QRect(115, 120, 101, 20))

        self.btnUbah = QPushButton(Form)
        self.btnUbah.setObjectName(u"btnUbah")
        self.btnUbah.setGeometry(QRect(225, 120, 81, 20))

        self.btnBersih = QPushButton(Form)
        self.btnBersih.setObjectName(u"btnBersih")
        self.btnBersih.setGeometry(QRect(140, 140, 56, 18))
        ...
        self.tabelPegawai.setGeometry(QRect(10, 190, 301, 192))

        # ===== Kolom Pencarian =====
        self.editCari = QLineEdit(Form)
        self.editCari.setObjectName(u"editCari")
        self.editCari.setGeometry(QRect(10, 160, 291, 20))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"Form Pegawai", None))
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("Form", u"ID Pegawai", None))
